...
class block_queue
{
  ...
  public:
    ...
    // Add element to queue, firstly need to wake up all thread which use this
    // queue. When push an element, simulate to producer that produce a
    // merchandise. If there is no thread who watting for conditon variable,
    // non-sense of wake.
    bool
    push (const T &item)
    {
